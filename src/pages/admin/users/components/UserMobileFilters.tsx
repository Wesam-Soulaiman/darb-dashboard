...
const setFilterValue = (
  ...
  const filtersWithoutCurrent = filters.filter((filter) => filter.id !== id);
...
const UserMobileFilters = ({
  ...
  const organizationId = getFilterValue(columnFilters, "organizationId");
  ...
  const updateFilter = (id: string, value: string) => {
    setColumnFilters((current) => setFilterValue(current, id, value));
      ...
      <Stack spacing={2}>
        ...
        >
          <Stack direction="row" spacing={1} sx={{ alignItems: "center" }}>
            ...
            <Box>
              <Typography sx={{ fontWeight: 800 }}>{t("table.filters")}</Typography>
        ...
        >
          ...
          <MenuItem value={"ACTIVE" satisfies OperationalProfileStatus}>
            {t("users.status.ACTIVE")}
          </MenuItem>

          <MenuItem value={"ON_LEAVE" satisfies OperationalProfileStatus}>
            {t("users.status.ON_LEAVE")}
          </MenuItem>

          <MenuItem value={"TERMINATED" satisfies OperationalProfileStatus}>
